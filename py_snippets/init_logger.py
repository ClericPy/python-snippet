...
__doc__ = '''Args:
    log_name = 'unnamed'
    path_levels = [['loggerfile.log',13],['','DEBUG'],['','info'],['','notSet']] # [[path,level]]
...
def init_logger(log_name='unnamed', path_levels=None, level=1, formatter=None,
                formatter_str=None):
    '''Args:
    log_name = 'unnamed'
    path_levels = [['loggerfile.log',13],['','DEBUG'],['','info'],['','notSet']] # [[path,level]]
    ...
    path_levels = path_levels or [['', 'INFO']]

    # ---------------------------------------
    for each_handler in path_levels:
